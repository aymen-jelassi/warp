...
RegisterNetEvent('warp-lib:cl_request')
AddEventHandler('warp-lib:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('warp-lib:cl_response', src, origin, callId, response)
end)