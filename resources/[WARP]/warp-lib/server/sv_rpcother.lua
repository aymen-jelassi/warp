...
RegisterNetEvent('warp-rpc:cl_request')
AddEventHandler('warp-rpc:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('warp-rpc:cl_response', src, origin, callId, response)
end)