...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('warp-lib:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('warp-lib:cl_response')
AddEventHandler('warp-lib:cl_response', function(origin, callId, response)
