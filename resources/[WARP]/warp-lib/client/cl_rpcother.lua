...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('warp-rpc:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('warp-rpc:cl_response')
AddEventHandler('warp-rpc:cl_response', function(origin, callId, response)
