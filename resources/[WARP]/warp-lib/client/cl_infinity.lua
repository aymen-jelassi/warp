function IsPlayerActive(pServerId)
    return exports['warp-infinity']:IsPlayerActive(pServerId)
end

function DoesPlayerExist(pServerId)
    return exports['warp-infinity']:DoesPlayerExist(pServerId)
end
...
function GetNetworkedCoords(pType, pNetId)
    return exports['warp-infinity']:GetNetworkedCoords(pType, pNetId)
end

function GetLocalEntity(pType, pNetId)
    return exports['warp-infinity']:GetLocalEntity(pType, pNetId)
end