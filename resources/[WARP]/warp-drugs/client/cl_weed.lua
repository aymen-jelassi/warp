...
-- RegisterNetEvent('warp-weed:knownCrops')
-- AddEventHandler('warp-weed:knownCrops', function(sentInfo, currentTime)
...
-- RegisterNetEvent('warp-weed:plantSeed')
-- AddEventHandler('warp-weed:plantSeed', function(sentType)
--     if not isBusy then
--         if exports["warp-inventory"]:hasEnoughOfItem("plantpot",1,false) then
...
--                 DeleteEntity(CreatedObject)
--                 local finished = exports["warp-taskbar"]:taskBar(math.random(8000, 12000),"Planting",false,false)
--                 if (finished == 100) then
--                     if exports["warp-inventory"]:hasEnoughOfItem(sentType,1,false) then
...
-- RegisterNetEvent('warp-weed:destroyPlant')
-- AddEventHandler('warp-weed:destroyPlant', function(coords)
--     if not isBusy then
--         isBusy = true
...
--                             TriggerServerEvent("warp-weed:killplant", knownCrops[knownInfo['id']]['knownId'])
--                             break
--                         end
--                     end
--                 end)
...
-- 	TriggerServerEvent("warp-weed:newplant", coordsX, coordsY, coordsZ, sentType)
-- end 

-- RegisterNetEvent('warp-weed:updatePlant')
-- AddEventHandler('warp-weed:updatePlant', function(updateType, sentId, sentGrowth, sentTime, sentStatus, sentNewInfo, currentTime)
...
--                         if knownCrops[closest]["growth"] >= 100 then
--                             local finished = exports["warp-taskbar"]:taskBar(1000, "Picking Plant", false, false)
--                             if (finished == 100) then
--                                 TriggerServerEvent('warp-weed:killplant', knownCrops[closest]["knownId"])
...
--                             end 
--                         elseif num == 2 then
--                             if exports["warp-inventory"]:hasEnoughOfItem("purifiedwater",1,false) then
--                                 TriggerEvent("inventory:removeItem", "purifiedwater", 1)
--                                 local new = math.ceil(knownCrops[closest]["growth"] + math.random(10,15))
--                                 TriggerServerEvent("warp-weed:updateStatus", 'update', knownCrops[closest]["knownId"], new, 'water')
--                             else
--                                 TriggerEvent("DoLongHudText", "You need purified water.", 2)
--                             end
               
--                         elseif num == 3 then
--                             if exports["warp-inventory"]:hasEnoughOfItem("fertilizer",1,false) then
--                                 TriggerEvent("inventory:removeItem", "fertilizer", 1)
--                                 local new = math.ceil(knownCrops[closest]["growth"] + math.random(10,15))
--                                 TriggerServerEvent("warp-weed:updateStatus", 'update', knownCrops[closest]["knownId"], new, 'fertilizer')
--                             else
