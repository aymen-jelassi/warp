...
Citizen.CreateThread(function()
  exports["warp-binds"]:registerKeyMapping("", "Player", "Drop Prop", "+propAttachDrop", "-propAttachDrop")
...
RegisterNetEvent('warp-propattach:attach')
AddEventHandler('warp-propattach:attach', function(pPropItem, pTargetFunction)
...
AddEventHandler('attachcarryObject', function(attachModelSent,boneNumberSent,x,y,z,xR,yR,zR)
	...
	SetEntityInvincible(carryObject, true)
end)
