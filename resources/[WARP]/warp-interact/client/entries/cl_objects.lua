    ...
    data = {
        {
            ...
            label = "Pickup trash",
            icon = "circle",
            event = "warp-jobs:sanitationWorker:pickupTrash",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Loot!",
            icon = "circle",
            event = "warp-heists:svclientloot",
            parameters = {}
        }
    },
    options = {
