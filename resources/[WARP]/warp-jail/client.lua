...
function RoleplayStats()
    ...
    if exports["warp-inventory"]:hasEnoughOfItem("shitlockpick",1,false) then
        totalroleplay = totalroleplay + 10
    end

    if exports["warp-inventory"]:hasEnoughOfItem("jailfood",1,false) then
        totalroleplay = totalroleplay + 10
    end

    if exports["warp-inventory"]:hasEnoughOfItem("methbag",1,false) then
        totalroleplay = totalroleplay + 15
    end

    if exports["warp-inventory"]:hasEnoughOfItem("assphone",1,false) then
        totalroleplay = totalroleplay + 15
    ...
    if exports["warp-inventory"]:hasEnoughOfItem("slushy",1,false) then
        totalroleplay = totalroleplay + 10
    end
...
function InmateHasAll()
    if exports["warp-inventory"]:hasEnoughOfItem("slushy",1,false)
        and
        exports["warp-inventory"]:hasEnoughOfItem("-1810795771",1,false)
        and
        exports["warp-inventory"]:hasEnoughOfItem("methbag",1,false)
        and
        exports["warp-inventory"]:hasEnoughOfItem("assphone",1,false)
        and
        exports["warp-inventory"]:hasEnoughOfItem("slushy",1,false)
    then
        return true
    else
        return false
...
RegisterNetEvent('warp-jail:checkTime')
AddEventHandler('warp-jail:checkTime', function()
...
AddEventHandler('swappingCharsLoop', function()
    ...
    DoScreenFadeOut(500)
    Citizen.Wait(1000)
    TriggerEvent("warp-base:clearStates")
    exports["warp-base"]:getModule("SpawnManager"):Initialize()
    relogging = true
    imjailed = false
...
-- Job 1
    ...
    -- Electrical Job 1 
    exports["warp-polytarget"]:AddBoxZone("dreams_electrical_job_1", vector3(1695.93,2536.057,45.55283), 1, 1.8, {
        heading=270,
        minZ=41.77,
        maxZ=45.77
    })

    exports["warp-interact"]:AddPeekEntryByPolyTarget("dreams_electrical_job_1", {
    {
        event = "warp-jail:work-box-1",
    ...
    RegisterNetEvent('warp-jail:work-box-1')
    AddEventHandler('warp-jail:work-box-1', function()
        TriggerEvent("animation:PlayAnimation","welding")
        FreezeEntityPosition(PlayerPedId(), true)
        ElectricalJob1 = false
        local finished = exports['warp-taskbar']:taskBar(7500, 'Repairing Electrical Box')
        if finished == 100 then
            ElectricalJobInProgress = false
            FreezeEntityPosition(PlayerPedId(), false)
            TriggerServerEvent('warp-jail:remove-time-electrical')
    ...
    -- Electrical Job 2 
    exports["warp-polytarget"]:AddBoxZone("dreams_electrical_job_2", vector3(1652.62, 2565.13, 45.56), 2, 3.4, {
        heading=0,
        minZ=42.96,
        maxZ=46.96
    })

    exports["warp-interact"]:AddPeekEntryByPolyTarget("dreams_electrical_job_2", {
    {
        event = "warp-jail:work-box-2",
    ...
    RegisterNetEvent('warp-jail:work-box-2')
    AddEventHandler('warp-jail:work-box-2', function()
        TriggerEvent("animation:PlayAnimation","welding")
        FreezeEntityPosition(PlayerPedId(), true)
    ...
    -- Electrical Job 3 
    exports["warp-polytarget"]:AddBoxZone("dreams_electrical_job_3", vector3(1630.0, 2565.25, 45.56), 2, 3.8, {
        heading=0,
        minZ=43.16,
        maxZ=47.16
    })

    exports["warp-interact"]:AddPeekEntryByPolyTarget("dreams_electrical_job_3", {
    {
        event = "warp-jail:work-box-3",
    ...
    RegisterNetEvent('warp-jail:work-box-3')
    AddEventHandler('warp-jail:work-box-3', function()
        TriggerEvent("animation:PlayAnimation","welding")
        FreezeEntityPosition(PlayerPedId(), true)
    ...
    -- Electrical Job 4 
    exports["warp-polytarget"]:AddBoxZone("dreams_electrical_job_4", vector3(1617.3387, 2578.6164, 45.552791), 2, 2.2, {  
        heading=270,
        minZ=43.36,
        maxZ=47.36
    })

    exports["warp-interact"]:AddPeekEntryByPolyTarget("dreams_electrical_job_4", {
    {
        event = "warp-jail:work-box-4",
    ...
    RegisterNetEvent('warp-jail:work-box-4')
    AddEventHandler('warp-jail:work-box-4', function()
        TriggerEvent("animation:PlayAnimation","welding")
        FreezeEntityPosition(PlayerPedId(), true)
    ...
    -- Electrical Job 5 
    exports["warp-polytarget"]:AddBoxZone("dreams_electrical_job_5", vector3(1630.5155, 2527.2539, 45.552795), 1, 1, {
        heading=315,
        minZ=42.77,
        maxZ=46.77
    })

    exports["warp-interact"]:AddPeekEntryByPolyTarget("dreams_electrical_job_5", {
    {
        event = "warp-jail:work-box-5",
    ...
    RegisterNetEvent('warp-jail:work-box-5')
    AddEventHandler('warp-jail:work-box-5', function()
        TriggerEvent("animation:PlayAnimation","welding")
        FreezeEntityPosition(PlayerPedId(), true)
    ...
    -- Electrical Job 6 
    exports["warp-polytarget"]:AddBoxZone("dreams_electrical_job_6", vector3(1655.8526, 2489.7385, 45.552795), 1, 1, {
        heading=315,
        minZ=42.77,
        maxZ=46.77
    })

    exports["warp-interact"]:AddPeekEntryByPolyTarget("dreams_electrical_job_6", {
    {
        event = "warp-jail:work-box-6",
    ...
    RegisterNetEvent('warp-jail:work-box-6')
    AddEventHandler('warp-jail:work-box-6', function()
        TriggerEvent("animation:PlayAnimation","welding")
        FreezeEntityPosition(PlayerPedId(), true)
    ...
    -- Electrical Job 7 
    exports["warp-polytarget"]:AddBoxZone("dreams_electrical_job_7", vector3(1657.6341, 2489.0827, 45.552795), 1, 1, {
        heading=315,
        minZ=42.76,
        maxZ=46.76
    })

    exports["warp-interact"]:AddPeekEntryByPolyTarget("dreams_electrical_job_7", {
    {
        event = "warp-jail:work-box-7",
    ...
    RegisterNetEvent('warp-jail:work-box-7')
    AddEventHandler('warp-jail:work-box-7', function()
        TriggerEvent("animation:PlayAnimation","welding")
        FreezeEntityPosition(PlayerPedId(), true)
    ...
    -- Electrical Job 8 
    exports["warp-polytarget"]:AddBoxZone("dreams_electrical_job_8", vector3(1666.4895, 2487.8957, 45.552833), 2, 2.2, {
        heading=275,
        minZ=43.36,
        maxZ=47.36
    })

    exports["warp-interact"]:AddPeekEntryByPolyTarget("dreams_electrical_job_8", {
    {
        event = "warp-jail:work-box-8",
    ...
    RegisterNetEvent('warp-jail:work-box-8')
    AddEventHandler('warp-jail:work-box-8', function()
        TriggerEvent("animation:PlayAnimation","welding")
        FreezeEntityPosition(PlayerPedId(), true)
    ...
    RegisterNetEvent('warp-jail:electrical-get-job')
    AddEventHandler('warp-jail:electrical-get-job', function()
    ...
    RegisterNetEvent("warp-rentals:bmx")
    AddEventHandler("warp-rentals:bmx", function()
    TriggerEvent('warp-context:sendMenu', {
      ...
      },
      {
        ...
        params = {
          event = "warp-rentals:attemptvehiclespawn1",
          args = {
              vehicle = "bmx",
          }
        }
...
local vehicleList = {
  ...
  RegisterNetEvent("warp-rentals:attemptvehiclespawn1")
AddEventHandler("warp-rentals:attemptvehiclespawn1", function(data)
  local vehicle = data.vehicle
  if IsAnyVehicleNearPoint(117.84, -1079.95, 29.23, 3.0) then
    TriggerEvent("DoLongHudText", "There's a vehicle in the way!", 2)
    return
  else
    TriggerServerEvent("warp-rentals:attemptPurchase1",vehicle)
  end 
end)

RegisterNetEvent("warp-rentals:attemptvehiclespawnfail1")
AddEventHandler("warp-rentals:attemptvehiclespawnfail", function()
    TriggerEvent("DoLongHudText", "Not enough money!", 2)
end)

RegisterNetEvent("warp-rentals:vehiclespawn1")
AddEventHandler("warp-rentals:vehiclespawn1", function(data, cb)
...
AddEventHandler("Trash:prison", function()
    local bitch = exports['warp-inventory']:getQuantity("trashbag")
    if bitch >= 1 then        
        ...
        local finished = exports["warp-taskbar"]:taskBar(10000,"Picking up trash")
        if finished == 100 then

                
            local itemLimit1 = exports['warp-inventory']:getQuantity("cigarette")
            local itemLimit2 = exports['warp-inventory']:getQuantity("asslockpick")
            local itemLimit3 = exports['warp-inventory']:getQuantity("aluminium")
            local itemLimit4 = exports['warp-inventory']:getQuantity("copper")
            local itemLimit5 = exports['warp-inventory']:getQuantity("copperbar")
            local itemLimit6 = exports['warp-inventory']:getQuantity("ironbar")
...
-- end of cleaning job
    ...
    RegisterNetEvent('warp-jobs:jail-jobs:menu', function()
        TriggerEvent('warp-context:sendMenu', {
            {
                id = 0,
                header = "Jail Job",
            ...
            },
            {
                ...
                params = {
                    event = "warp-jail:electrical-get-job",
                },
            },
        })
    end)