...
RegisterNetEvent('warp-showroom:SpawnVehicle')
AddEventHandler('warp-showroom:SpawnVehicle', function(veh, price, plate)
    ...
    TriggerServerEvent('warp-showroom:purchaseVehicle', plate, name, vehicle, price, VehicleProps)
end)
