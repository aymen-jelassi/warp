...
var ShowroomFunctions = {
    ...
    GetCars: function () {
        $.post('https://warp-showroom/np-ui:showroomChangeCar', JSON.stringify({ model: cars[selectedId].model }), function (cb) {
...
$(document).ready(function () {
    ...
    window.addEventListener('message', (event) => {
        ...
        if (data.meta.message = "done") {
            ...
            $.post('https://warp-showroom/warp-ui:application-closed', JSON.stringify({ name: "showroom" }));
        }
    })
});
...
$(document).on("click", "#purchase", function () {
    ...
    $(".showroom-wrapper").hide();
    $.post('https://warp-showroom/warp-ui:application-closed', JSON.stringify({ name: "showroom" }));
    $.post('https://warp-showroom/showroomPurchaseCurrentVehicle', JSON.stringify({ model: cars[selectedId].model, price:cars[selectedId].price, zoneName: zone }), function(cb){
     if( cb.meta.ok) {
        ShowroomFunctions.Close()
        canPress = false
     } else {
