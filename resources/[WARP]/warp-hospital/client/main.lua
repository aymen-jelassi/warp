...
function LeaveBed()
    ...
    TriggerServerEvent('warp-hospital:server:LeaveBed', bedOccupying)
...
RegisterNetEvent('warp-hospital:client:RPCheckPos')
AddEventHandler('warp-hospital:client:RPCheckPos', function()
    TriggerServerEvent('warp-hospital:server:RPRequestBed', GetEntityCoords(PlayerPedId()))
end)

RegisterNetEvent('warp-hospital:client:RPSendToBed')
AddEventHandler('warp-hospital:client:RPSendToBed', function(id, data)
    bedOccupying = id
...
RegisterNetEvent('warp-hospital:client:SendToBed')
AddEventHandler('warp-hospital:client:SendToBed', function(id, data)
    bedOccupying = id
    bedOccupyingData = data
    ...
    Citizen.CreateThread(function ()
        ...
        TriggerServerEvent('warp-hospital:server:EnteredBed')
    end)
end)

RegisterNetEvent('warp-hospital:client:FinishServices')
AddEventHandler('warp-hospital:client:FinishServices', function()
