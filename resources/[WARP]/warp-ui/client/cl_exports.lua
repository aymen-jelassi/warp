...
RegisterNetEvent("warp-ui:open-application")
AddEventHandler("warp-ui:open-application", openApplication)
...
function closeApplication(app, data)
    ...
    TriggerEvent("warp-ui:application-closed", app, { fromEscape = false })
end
