...
RegisterNUICallback("closeeyeint", function(data,cb)
    ...
    TriggerEvent("warp-interact:detali")
    cb("ok")
end)

-- RegisterNUICallback("warp-ui:targetSelectOption", function(data, cb)
...
RegisterCommand("testcontextmenu", function()
    local menuData = {
        ...
        },
        {
            ...
            key = "EVENTS.EVIDENCE",
            children = {
                { title = "Confirm Purchase", action = "warp-ui:rentalPurchase", key = "EVENTS.EVIDENCE" },
            },
        },
        {
            title = "Trash",
        ...
        },
        {
            ...
            key = "EVENTS.SWITCHER",
            children = {
                { title = "Confirm Purchase", action = "warp-ui:rentalPurchase", key = "EVENTS.SWITCHER" },
            },
        },
    }
...
-- Show Interaction
-- exports["warp-ui"]:showInteraction(msg,type)
