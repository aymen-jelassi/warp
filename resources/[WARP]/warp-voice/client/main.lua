...
AddEventHandler('warp-voice:settingsCallback', function(cb)
	cb(Cfg)
end)
...
RegisterCommand('+cycleproximity', function()
	...
	TriggerEvent('warp-voice:setTalkingMode', voiceMode)
	TriggerEvent("warp-hud:changeRange", voiceMode)
end, false)
RegisterCommand('-cycleproximity', function()
end)
...
RegisterNetEvent('warp-voice:toggleMute', toggleMute)
...
function setVoiceProperty(type, value)
	...
	elseif type == "micClicks" then
		...
		micClicks = val
		SetResourceKvp('warp-voice_enableMicClicks', val)
	end
end
...
AddEventHandler('onClientResourceStart', function(resource)
	...
	local micClicksKvp = GetResourceKvpString('warp-voice_enableMicClicks')
	if not micClicksKvp then
		SetResourceKvp('warp-voice_enableMicClicks', tostring(true))
	else
