...
AddEventHandler('spawn:clientSpawnData', function(spawnData)
		...
		--[[if Spawn.housingCoords == nil then
			Spawn.housingCoords = exports["warp-housing"]:retriveHousingTable();
		end]]
...
RegisterNetEvent("warp-spawn:firstspawnyo")
AddEventHandler("warp-spawn:firstspawnyo", function()
    if GetEntityModel(PlayerPedId()) == GetHashKey("mp_f_freemode_01") then
        TriggerEvent("warp-spawn:finishedClothingstuffbish")
    else
        TriggerEvent("warp-spawn:finishedClothingstuff")
    end
end)

RegisterNetEvent('warp-spawn:finishedClothingstuff')
AddEventHandler('warp-spawn:finishedClothingstuff', function()
...
RegisterNetEvent('warp-spawn:finishedClothingstuffbish')
AddEventHandler('warp-spawn:finishedClothingstuffbish', function()
