...
-- RegisterNetEvent('warp-vault:firstdoor')
-- AddEventHandler('warp-vault:firstdoor', function()
...
--                         TriggerServerEvent('warp-doors:change-lock-state', 46, false) 
...
-- RegisterNetEvent('warp-vault:seconddoor')
-- AddEventHandler('warp-vault:seconddoor', function()
--     local player = GetEntityCoords(PlayerPedId())
...
--                         TriggerEvent('warp-hud:hide_hackerman')
--                         TriggerEvent("inventory:removeItem", "thermal_charge", 1)
--                         TriggerServerEvent('warp-doors:change-lock-state', 48, false) 
--                         TriggerEvent('warp-dispatch:bobcat_robbery')
--                         Citizen.Wait(3000)
--                         FreezeEntityPosition(PlayerPedId(), false)
--                     else
...
-- RegisterNetEvent('warp-vault:startvault')
-- AddEventHandler('warp-vault:startvault', function()
--     local player = GetEntityCoords(PlayerPedId())
--     local distance = #(vector3(253.25254, 228.45343, 101.68377) - player)
--     if distance < 1.5 then
--         if exports["warp-duty"]:LawAmount() >= 0 then
--             if exports["warp-inventory"]:hasEnoughOfItem("heistlaptop4", 1) then
--                 StartVaultKid()
--                 TriggerEvent('warp-hud:show_hackerman')
--                 TriggerEvent("client:newStress",true, 150)
...
-- RegisterNetEvent('warp-vault:lowerfirstdoor')
-- AddEventHandler('warp-vault:lowerfirstdoor', function()
--     local player = GetEntityCoords(PlayerPedId())
...
--                         TriggerEvent('warp-hud:hide_hackerman')
--                         TriggerEvent("inventory:removeItem", "thermal_charge", 1)
--                         TriggerServerEvent('warp-doors:change-lock-state', 49, false) 
--                         TriggerEvent('warp-dispatch:bobcat_robbery')
--                         Citizen.Wait(3000)
--                         FreezeEntityPosition(PlayerPedId(), false)
--                     else
...
-- RegisterNetEvent('warp-vault:lowerseconddoor')
-- AddEventHandler('warp-vault:lowerseconddoor', function()
--     local player = GetEntityCoords(PlayerPedId())
...
--                         TriggerEvent('warp-hud:hide_hackerman')
--                         TriggerEvent("inventory:removeItem", "thermal_charge", 1)
--                         TriggerServerEvent('warp-doors:change-lock-state', 50, false) 
--                         TriggerEvent('warp-dispatch:bobcat_robbery')
--                         Citizen.Wait(3000)
--                         FreezeEntityPosition(PlayerPedId(), false)
--                     else
...
-- RegisterNetEvent("warp-vault:grab", function()
...
-- RegisterNetEvent('warp-vault:startlowervault')
-- AddEventHandler('warp-vault:startlowervault', function()
--     local player = GetEntityCoords(PlayerPedId())
...
--     if success2 then
--         TriggerServerEvent('warp-doors:change-lock-state', 278, false) 
--         TriggerServerEvent("warp-doors:change-lock-state", 279, false)
--         CreatenzylozCrates()
--     end
-- end
...
--     if distance < 1.5 then
--   exports['warp-vault']:OpenVaultGame(function(success)
--     if success then
--         TriggerServerEvent("warp-doors:change-lock-state", 325, false)
--       print("280")  
--     else
