...
AddEventHandler("store:dosafe", function()
	local storeid = isStoreRobbery()
		TriggerEvent("warp-dispatch:storerobbery2")
		TriggerServerEvent("police:camrobbery",storeid)
		TriggerEvent("client:newStress", true, 90)
...
AddEventHandler("store:register", function(storeid,regid)
		TriggerEvent("warp-dispatch:storerobbery2")
		TriggerServerEvent("police:camrobbery",storeid)
		TriggerEvent("client:newStress", true, 45)
...
RegisterNetEvent("warp-robberies:HitSafes")
AddEventHandler("warp-robberies:HitSafes", function()
	local storeid = isStoreRobbery()
	if storeid ~= 0 then
...
RegisterNetEvent("warp-robberies:HitRegister")
AddEventHandler("warp-robberies:HitRegister", function()
...
AddEventHandler("robbery:safe", function()
	...
	TriggerEvent("inventory:removeItem",'codenotepad', 1)
