...
function UseBankPanel(panelCoords, panelHeading)
    ...
    Wait(1000)
    TriggerServerEvent("warp-fleeca:startCoolDown")
    Citizen.CreateThread(function()
        exports['warp-hacking']:OpenHackingGame(function(minigameResult)
...
RegisterNetEvent("warp-fleeca:resetdoors", function()
    ResetDoors()
end)
...
RegisterCommand('testbro', function()
    TriggerEvent('warp-duty:PoliceMenu')
end)
...
function Loot()
    ...
    TriggerServerEvent("warp-fleeca:giveMoney")
    TriggerEvent('warp-hud:hide_money')
end

RegisterNetEvent("warp-fleeca:grab")
AddEventHandler("warp-fleeca:grab", function()
    print('called 1?')
...
RegisterNetEvent('warp-loot_fleeca')
AddEventHandler('warp-loot_fleeca', function()
    print('called 2?')
    TriggerServerEvent('warp-fleeca:tut_tut')
end)

RegisterNetEvent("warp-fleeca:laptopused", function(id)
...
AddEventHandler("warp-inventory:itemUsed", function(item, info)
    if item == "heistlaptop3" then 
        TriggerServerEvent("warp-fleeca:laptop1")
    end
end)
...
RegisterNetEvent('warp-heists:fleeca_available')
AddEventHandler('warp-heists:fleeca_available', function()
...
RegisterNetEvent('warp-heists:fleeca_unavailable')
AddEventHandler('warp-heists:fleeca_unavailable', function()
    TriggerEvent('warp-context:sendMenu', {
        {
            id = 1,
            header = "< Go Back",
