...
RegisterNetEvent('warp-remoteCalls:cl_request')
AddEventHandler('warp-remoteCalls:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('warp-remoteCalls:cl_response', src, origin, callId, response)
end)