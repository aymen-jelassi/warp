...
$(document).ready(() => {
    ...
    $(".profile-items").on("click", ".profile-item", function () {
        let id = $(this).data("id");
        $.post('https://warp-mdt/getProfileData', JSON.stringify({
            id: id
        }));
    })
    ...
    $(".bulletin-items-continer").on("keydown", ".bulletin-item", function (e) {
        if (e.keyCode === 13) {
            ...
            let time = new Date()
            $.post('https://warp-mdt/newBulletin', JSON.stringify({
                title: title,
                info: info,
                time: time.getTime()
            }));
    ...
    $(".contextmenu").on("click", ".remove-bulletin", function () {
        ...
        $.post('https://warp-mdt/deleteBulletin', JSON.stringify({
            id: BulletinId,
            time: time.getTime()
        }));
        ...
        if (e.keyCode === 13) {
            ...
            if (URL !== "") {
                ...
                setTimeout(() => {
                    ...
                    $.post('https://warp-mdt/addGalleryImg', JSON.stringify({
                        cid: cid,
                        URL: URL
                    }));
                }, 250);
    ...
    $(".manage-profile-save").click(function () {
        if (canSaveProfile == true) {
            ...
            setTimeout(() => {
                ...
                $.post('https://warp-mdt/saveProfile', JSON.stringify({
                    pfp: pfp,
    ...
    $(".manage-incidents-title-holder").on("click", ".manage-incidents-save", function () {
        if (canSaveProfile == true) {
            ...
            $.post('https://warp-mdt/saveIncident', JSON.stringify({
                ID: dbid,
                title: title,
            ...
            setTimeout(() => {
                if (canRefreshIncidents == true) {
                    ...
                    setTimeout(() => {
                        ...
                        $.post('https://warp-mdt/getAllIncidents', JSON.stringify({}));
                    }, 1500);
                }
            }, 1000);
    ...
    $(".contextmenu").on("click", ".search-vehicle", function () {
       ...
       setTimeout(() => {
           ...
           setTimeout(() => {
               ...
               $.post('https://warp-mdt/searchVehicles', JSON.stringify({
                   name: plate.toString()
               }));
               $(".dmv-items").empty();
                $('.dmv-items').prepend(`<div class="profile-loader"></div>`);
               setTimeout(() => {
                   $.post('https://warp-mdt/getVehicleData', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".search-weapon", function () {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                $.post('https://warp-mdt/searchWeapon', JSON.stringify({
                    name: plate.toString()
                }));
                $(".weapons-items").empty();
                $('.weapons-items').prepend(`<div class="profile-loader"></div>`);
                setTimeout(() => {
                    $.post('https://warp-mdt/getWeaponData', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".revoke-licence", function () {
        if (pJob == 'police' || pJob == 'state' || pJob == 'sheriff') {
            $.post('https://warp-mdt/updateLicence', JSON.stringify({
    ...
    $('#profile-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (name !== "") {
                ...
                $.post('https://warp-mdt/searchProfiles', JSON.stringify({
                    name: name
                }));
                $(".profile-items").empty();
    ...
    $('#incidents-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (incident !== "") {
                canSearchForProfiles = false
                $.post('https://warp-mdt/searchIncidents', JSON.stringify({
                    incident: incident
                }));
    ...
    $('#dispatchmsg').keydown(function (e) {
        ...
        if (keyCode === 13 && !e.shiftKey) {
            e.preventDefault()
            const time = new Date()
            $.post('https://warp-mdt/dispatchMessage', JSON.stringify({
                message: $(this).val(),
                time: time.getTime()
            }));
            $(this).val("")
    ...
    $(".incidents-items").on("click", ".incidents-item", function () {
        ...
        $.post('https://warp-mdt/getIncidentData', JSON.stringify({
            id: id
        }));
    })
    ...
    document.onkeyup = function (data) {
        if (data.which == 27) {
            ...
            if (shouldClose == true) {
                $.post('https://warp-mdt/escape', JSON.stringify({}));
            }
        }
    };
    ...
    $(".icidents-person-search-name-input").on("keydown", "", function (e) {
        if (e.keyCode === 13) {
            ...
            $.post('https://warp-mdt/incidentSearchPerson', JSON.stringify({
                name: name
            }));
        }
    });
    ...
    $(".manage-bolos-title-holder").on("click", ".manage-bolos-save", function () {
        ...
        $.post('https://warp-mdt/newBolo', JSON.stringify({
            existing: existing,
            id: id,
            title: title,
            plate: plate,
    ...
    $('#bolos-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (searchVal !== "") {
                canSearchForProfiles = false
                $.post('https://warp-mdt/searchBolos', JSON.stringify({
                    searchVal: searchVal
                }));
                $(".bolos-items").empty();
    ...
    $(".bolos-search-refresh").click(function () {
        if (canRefreshBolo == true) {
            ...
            setTimeout(() => {
                ...
                canRefreshBolo = true
                $.post('https://warp-mdt/getAllBolos', JSON.stringify({}));
            }, 1500);
        }
    });
    ...
    $(".bolos-items").on("click", ".bolo-item", function () {
        ...
        canInputBoloOfficerTag = true
        let id = $(this).data("id");
        $.post('https://warp-mdt/getBoloData', JSON.stringify({
            id: id
        }));
    })
    ...
    $(".contextmenu").on("click", ".bolo-delete", function () { 
        ...
        if ($(this).data("info") != 0) {
            if ($(".badge-logo").attr('src') == 'https://i.imgur.com/B9zsyBj.png') {
                ...
                $.post('https://warp-mdt/deleteICU', JSON.stringify({
                id: $(this).data("info")
            }));
        }
        $(".bolos-items").find("[data-id='" + $(this).data("info") + "']").remove();
        $.post('https://warp-mdt/deleteBolo', JSON.stringify({
            id: $(this).data("info"),
    ...
    $(".contextmenu").on("click", ".incident-delete", function () { 
        ...
        $.post('https://warp-mdt/deleteIncident', JSON.stringify({
            id: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".missing-delete", function () { 
        ...
        $.post('https://warp-mdt/deleteMissing', JSON.stringify({
            id: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".profile-missing", function () { 
        $.post('https://warp-mdt/missingCitizen', JSON.stringify({
            cid: $(this).data("info"),
    ...
    $(".contextmenu").on("click", ".report-delete", function () { 
        ...
        $.post('https://warp-mdt/deleteReport', JSON.stringify({
            id: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".add-charge", function () { 
        ...
        $.post('https://warp-mdt/getPenalCode', JSON.stringify({}));
    });
    ...
    $(".contextmenu").on("click", ".associated-incidents-remove-tag", function () { 
        ...
        if (incidentId != 0) {
            $.post('https://warp-mdt/removeIncidentCriminal', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".incidents-remove-normal-tag", function () { 
        ...
        let cid = $(".manage-profile-citizenid-input").val();
        if (cid) {
            $.post('https://warp-mdt/removeProfileTag', JSON.stringify({
                cid: cid,
                text: $(this).data("info")
            }));
        }
    ...
    $(".reports-search-refresh").click(function () {
        if (canRefreshReports == true) {
            ...
            setTimeout(() => {
                ...
                $.post('https://warp-mdt/getAllReports', JSON.stringify({}));
            }, 1500);
        }
    });
    $(".dispatch-comms-refresh").click(function(){
        ...
        setTimeout(() => {
            ...
            canRefreshReports = true
            $.post('https://warp-mdt/refreshDispatchMsgs', JSON.stringify({}));
        }, 1500);
    })
    $(".reports-items").on("click", ".reports-item", function () {
        ...
        let id = $(this).data("id");
        $.post('https://warp-mdt/getReportData', JSON.stringify({
            id: id
        }));
    })
    ...
    $('#reports-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForReports == true) {
            ...
            if (name !== "") {
                ...
                $.post('https://warp-mdt/searchReports', JSON.stringify({
                    name: name
                }));
                $(".reports-items").empty();
    ...
    $(".manage-reports-title-holder").on("click", ".manage-reports-save", function () {
        ...
        $.post('https://warp-mdt/newReport', JSON.stringify({
            existing: existing,
            id: id,
            title: title,
            type: type,
    ...
    $('#missing-search-input').keydown(function (e) {
        if (e.keyCode === 13) {
            ...
            if (name !== "") {
                $.post('https://warp-mdt/searchMissing', JSON.stringify({
                    name: name
                }));
                $(".missing-items").empty();
    ...
    $(".missing-items").on("click", ".missing-item", function () {
        $.post('https://warp-mdt/getMissingData', JSON.stringify({
            id: $(this).data("dbid")
        }));
    });
    ...
    $(".vehicle-information-title-holder").on("click", ".vehicle-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://warp-mdt/saveVehicleInfo', JSON.stringify({
                    dbid: dbid,
                    plate: plate,
                    imageurl: imageurl,
                    notes: notes
    ...
    $(".weapon-information-title-holder").on("click", ".weapon-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://warp-mdt/saveWeaponInfo', JSON.stringify({
                    dbid: dbid,
    ...
    $(".missing-information-title-holder").on("click", ".missing-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://warp-mdt/saveMissingInfo', JSON.stringify({
                    id: dbid,
                    imageurl: imageurl,
                    notes: notes
                }));
    ...
    $(".contextmenu").on("click", ".mark-code-5", function () { 
        ...
        if ( tag.hasClass("red-tag")) {
            ...
            $.post('https://warp-mdt/knownInformation', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".set-waypoint", function () { 
        let info = $(this).data("info")
        $.post('https://warp-mdt/setWaypointU', JSON.stringify({
            cid: info,
        }));
    })
    ...
    $(".contextmenu").on("click", ".Set-Waypoint", function () { 
        ...
        $.post('https://warp-mdt/setWaypoint', JSON.stringify({
            callid: callId,
        }));
    })
    ...
    $(".contextmenu").on("click", ".call-attach", function () { 
        const callId = $(this).data("info")
        $.post('https://warp-mdt/callAttach', JSON.stringify({
            callid: callId,
        }));
    })
    ...
    $(".contextmenu").on("click", ".call-detach", function () { 
        const callId = $(this).data("info")
        $.post('https://warp-mdt/callDetach', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $(".contextmenu").on("click", ".remove-call", function () { 
        ...
        $.post('https://warp-mdt/removeCall', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $(".contextmenu").on("click", ".attached-units", function () { 
        const callId = $(this).data("info")
        $.post('https://warp-mdt/attachedUnits', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $('#respondcalls').keydown(function (e) {
        ...
        if (keyCode === 13 && !e.shiftKey) {
            ...
            e.preventDefault();
            const time = new Date()
            $.post('https://warp-mdt/sendCallResponse', JSON.stringify({
                message: $(this).val(),
                time: time.getTime(),
                callid: callid
            }));
    ...
    $(".contextmenu").on("click", ".respond-call", function () {
        const callId = $(this).data("info")
        $.post('https://warp-mdt/getCallResponses', JSON.stringify({
            callid: callId
        }));
    ...
    $(".contextmenu").on("click", ".call-dispatch-detach", function () { 
        const cid = $(this).data("info")
        $.post('https://warp-mdt/callDispatchDetach', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".Set-Dispatch-Waypoint", function () { 
        const cid = $(this).data("info")
        $.post('https://warp-mdt/setDispatchWaypoint', JSON.stringify({
            callid: $(".dispatch-attached-units-container").attr("id"),
            cid: cid
        }));
    })
    ...
    $(".jail-buttons").on("click", ".jail-submit", function () {
        ...
        if (time.length > 0) {
            ...
            $.post('https://warp-mdt/jailPlayer', JSON.stringify({
                cid: cid,
                time: time
            }));
            $(".jail-inner-container").slideUp(500)
    ...
    $(".callsign-buttons").on("click", ".callsign-submit", function () {
        ...
        if (callsign.length > 2) {
            ...
            $.post('https://warp-mdt/setCallsign', JSON.stringify({
                cid: editingcallsign,
    ...
    $(".active-calls-list").on("click", ".active-calls-item", function (e) {
        ...
        if (callId && draggedElement) {
            $.post('https://warp-mdt/callDragAttach', JSON.stringify({
                callid: callId,
                cid: draggedElement
            }));
            draggedElement = 0
    ...
    window.addEventListener('message', function (event) {
        ...
        if (e.type == "show") {
            ...
            if ((BodyDisplay) == "block") {
                ...
                $.post('https://warp-mdt/dispatchNotif', JSON.stringify({
                    data: value,
                }));
            }
            $('.dispatch-items').scrollTop($('.dispatch-items')[0].scrollHeight)
...
function fidgetSpinner(page) {
    ...
    if (page == '.missing-page-container') {
        $.post('https://warp-mdt/getAllMissing', JSON.stringify({}));
    }
    if (page == '.reports-page-container') {
        $.post('https://warp-mdt/getAllReports', JSON.stringify({}));
    }
    if (page == '.stafflogs-page-container') {
        $.post('https://warp-mdt/getAllLogs', JSON.stringify({}));
    }
...
function addTag(tagInput) {
    ...
    $.post('https://warp-mdt/newTag', JSON.stringify({
...
function addWeapon(Input) {
    ...
    $.post('https://warp-mdt/newWeapon', JSON.stringify({
        id: $(".manage-profile-citizenid-input").val(),
        serialnumber: Input
    }));
}
...
function removeImage(url) {
    ...
    $.post('https://warp-mdt/removeGalleryImg', JSON.stringify({
        cid: cid,
        URL: url
    }));
}
