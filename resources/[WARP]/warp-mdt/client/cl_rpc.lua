...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('warp-remoteCalls:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('warp-remoteCalls:cl_response')
AddEventHandler('warp-remoteCalls:cl_response', function(origin, callId, response)
