...
RegisterNetEvent("warp-civjobs:package-chicken")
AddEventHandler("warp-civjobs:package-chicken", function(position)
	if exports["warp-inventory"]:hasEnoughOfItem("slaughtered_chicken", 2) then
		...
		local finishedpacking = exports['warp-taskbar']:taskBar(7500, 'Putting the chicken in the box')
...
RegisterNetEvent("dreams-civjobs:process-alive_chicken")
AddEventHandler("dreams-civjobs:process-alive_chicken", function(position)
	if exports["warp-inventory"]:hasEnoughOfItem("alive_chicken", 1) then
		...
		local finished = exports['warp-taskbar']:taskBar(10000, 'Cutting the Chicken')
...
RegisterNetEvent("dreams-chickens-start")
AddEventHandler("dreams-chickens-start", function()
	DoScreenFadeOut(500)
	Citizen.Wait(500)
...
Citizen.CreateThread(function()
	...
	Citizen.Wait(0)
		if ragdoll then
			...
			TriggerEvent('warp-hospital:client:ResetLimbs')
            TriggerEvent('warp-hospital:client:RemoveBleed')
			ragdoll = false
		end
	end
end)

RegisterNetEvent("dreams-chickens:sell")
AddEventHandler("dreams-chickens:sell", function()
	if exports["warp-inventory"]:hasEnoughOfItem("packaged_chicken",2,false) then 
		...
		local finished = exports['warp-taskbar']:taskBar(5000, 'Selling the chicken!')
		...
		if (finished == 100) then
			if exports["warp-inventory"]:hasEnoughOfItem("packaged_chicken",2,false) then 
				local chicken = math.random(300, 376)
...
DreamsChickenProcessStation1 = false

Citizen.CreateThread(function()
    exports["warp-polyzone"]:AddBoxZone("dreams_chicken_procces_station_1", vector3(-95.52, 6207.25, 31.03), 2, 1.8, {
        name="dreams_chicken_procces_station_1",
		heading=315,
		--debugPoly=true,
		minZ=28.23,
		maxZ=32.23
...
AddEventHandler('warp-polyzone:enter', function(name)
    if name == "dreams_chicken_procces_station_1" then
        DreamsChickenProcessStation1 = true     
        DreamsProccesStation1Chickens()
		exports['warp-textui']:showInteraction("[E] Process Alive Chicken")
    end
end)
...
function DreamsProccesStation1Chickens()
	Citizen.CreateThread(function()
        while DreamsChickenProcessStation1 do
            Citizen.Wait(5)
			if IsControlJustReleased(0, 38) then
				TriggerEvent('dreams-civjobs:process-alive_chicken')
			end
		end
	end)
end
...
DreamsChickenProcessStation2 = false

Citizen.CreateThread(function()
    exports["warp-polyzone"]:AddBoxZone("dreams_chicken_procces_station_2", vector3(-100.34, 6202.42, 31.03), 1, 1.8, {
        name="dreams_chicken_procces_station_2",
		heading=225,
		--debugPoly=true,
		minZ=28.03,
		maxZ=32.03
...
RegisterNetEvent('warp-polyzone:enter')
AddEventHandler('warp-polyzone:enter', function(name)
    if name == "dreams_chicken_procces_station_2" then
        DreamsChickenProcessStation2 = true     
        DreamsProccesStation2Chickens()
		exports['warp-textui']:showInteraction("[E] Process Alive Chicken")
    end
end)
...
function DreamsProccesStation2Chickens()
	Citizen.CreateThread(function()
        while DreamsChickenProcessStation2 do
            Citizen.Wait(5)
			if IsControlJustReleased(0, 38) then
				TriggerEvent('dreams-civjobs:process-alive_chicken')
			end
...
DreamsProcessSlaughtered1 = false

Citizen.CreateThread(function()
    exports["warp-polyzone"]:AddBoxZone("dreams_chicken_process_1", vector3(-99.97, 6211.17, 31.03), 2, 2, {
        name="dreams_chicken_process_1",
		heading=315,
		--debugPoly=true,
		minZ=28.43,
		maxZ=32.43
...
RegisterNetEvent('warp-polyzone:enter')
AddEventHandler('warp-polyzone:enter', function(name)
    if name == "dreams_chicken_process_1" then
        DreamsProcessSlaughtered1 = true     
        DreamsChickenProcess1()
		exports['warp-textui']:showInteraction("[E] Process Slaughtered Chicken [Bay 1]")
    end
end)
...
function DreamsChickenProcess1()
	Citizen.CreateThread(function()
        while DreamsProcessSlaughtered1 do
            Citizen.Wait(5)
			if IsControlJustReleased(0, 38) then
				TriggerEvent('warp-civjobs:package-chicken')
			end
		end
	end)
end
...
DreamsProcessSlaughtered2 = false

Citizen.CreateThread(function()
    exports["warp-polyzone"]:AddBoxZone("dreams_chicken_process_2", vector3(-102.1, 6208.91, 31.03), 2, 2, {
        name="dreams_chicken_process_2",
		heading=45,
		--debugPoly=true,
		minZ=28.43,
		maxZ=32.43
...
RegisterNetEvent('warp-polyzone:enter')
AddEventHandler('warp-polyzone:enter', function(name)
    if name == "dreams_chicken_process_2" then
        DreamsProcessSlaughtered2 = true     
        DreamsChickenProcess2()
		exports['warp-textui']:showInteraction("[E] Process Slaughtered Chicken [Bay 2]")
    end
end)
...
function DreamsChickenProcess2()
	Citizen.CreateThread(function()
        while DreamsProcessSlaughtered2 do
            Citizen.Wait(5)
			if IsControlJustReleased(0, 38) then
				TriggerEvent('warp-civjobs:package-chicken')
			end
...
DreamsProcessSlaughtered3 = false

Citizen.CreateThread(function()
    exports["warp-polyzone"]:AddBoxZone("dreams_chicken_process_3", vector3(-104.31, 6206.7, 31.03), 2, 2, {
        name="dreams_chicken_process_3",
		heading=315,
		debugPoly=false,
		minZ=28.43,
		maxZ=32.43
...
RegisterNetEvent('warp-polyzone:enter')
AddEventHandler('warp-polyzone:enter', function(name)
    if name == "dreams_chicken_process_3" then
        DreamsProcessSlaughtered3 = true     
        DreamsChickenProcess3()
		exports['warp-textui']:showInteraction("[E] Process Slaughtered Chicken [Bay 3]")
    end
end)
...
function DreamsChickenProcess3()
	Citizen.CreateThread(function()
        while DreamsProcessSlaughtered3 do
            Citizen.Wait(5)
			if IsControlJustReleased(0, 38) then
				TriggerEvent('warp-civjobs:package-chicken')
			end
...
DreamsChickenStart = false

Citizen.CreateThread(function()
    exports["warp-polyzone"]:AddBoxZone("dreams_chickens_start", vector3(2387.34, 5044.39, 46.31), 2, 2, {
        name="dreams_chickens_start",
		heading=310,
		--debugPoly=true,
		minZ=43.51,
		maxZ=47.51
...
RegisterNetEvent('warp-polyzone:enter')
AddEventHandler('warp-polyzone:enter', function(name)
    if name == "dreams_chickens_start" then
        DreamsChickenStart = true     
        DreamsRPChickensStart()
		exports['warp-textui']:showInteraction("[E] Start Catching Chickens")
    end
end)
...
function DreamsRPChickensStart()
	Citizen.CreateThread(function()
        while DreamsChickenStart do
            Citizen.Wait(5)
			if IsControlJustReleased(0, 38) then
				TriggerEvent('dreams-chickens-start')
			end
		end
	end)
end
...
DreamsChickensSales = false

Citizen.CreateThread(function()
    exports["warp-polyzone"]:AddBoxZone("dreams_chicken_sales", vector3(-591.81, -892.58, 25.81), 2, 2, {
        name="dreams_chicken_sales",
		heading=0,
		--debugPoly=true,
		minZ=23.81,
		maxZ=27.81
...
RegisterNetEvent('warp-polyzone:enter')
AddEventHandler('warp-polyzone:enter', function(name)
    if name == "dreams_chicken_sales" then
        DreamsChickensSales = true     
        DreamsChickensSalesFunction()
		exports['warp-textui']:showInteraction("[E] Sell Packaged Chickens")
    end
end)
...
function DreamsChickensSalesFunction()
	Citizen.CreateThread(function()
        while DreamsChickensSales do
            Citizen.Wait(5)
			if IsControlJustReleased(0, 38) then
				TriggerEvent('dreams-chickens:sell')
			end
		end
	end)
end