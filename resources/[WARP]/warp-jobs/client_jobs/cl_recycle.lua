...
function runRecycle()
	...
	exports["warp-taskbar"]:taskBar(1500,"Picking up material")
...
RegisterNetEvent('dreams-recycle:enter')
AddEventHandler('dreams-recycle:enter', function()
	DoScreenFadeOut(1)
	Citizen.Wait(100)
...
RegisterNetEvent('dreams-recycle:leave')
AddEventHandler('dreams-recycle:leave', function()
	CleanUpArea()
	DoScreenFadeOut(1)
	Citizen.Wait(100)
...
RegisterNetEvent('dreams-trade:mats')
AddEventHandler('dreams-trade:mats', function()
