        ...
        switch (event.data.action) {
            ...
            case 'showMenu':
                ...
                $('#hud-on').on('change', function () {
                    ...
                    $.post('https://warp-hud/hud_on', JSON.stringify({
                        hud_on: hud_on
                    }));
                });
                ...
                $('#compassinput').on('change', function () {
                    ...
                    $.post('https://warp-hud/compassinput', JSON.stringify({
                ...
                $('#compassTime').on('change', function () {
                    ...
                    $.post('https://warp-hud/compassTime', JSON.stringify({
                ...
                $('#compassStreet').on('change', function () {
                    ...
                    $.post('https://warp-hud/compassStreet', JSON.stringify({
                ...
                //     $(".speed").css("left" , "15.2vw");
                //     $.post('https://warp-hud/minimap_clip',JSON.stringify({
                //         d_minimap: d_minimap
                //     }));
                // });
                ...
                //     $(".speed").css("left" , "13.5vw");
                //     $.post('https://warp-hud/minimap_clip2',JSON.stringify({
                //         d_minimap: d_minimap
                //     }));
                // });
                ...
                $('#speedmeter').keyup(function () {
                    ...
                    $.post('https://warp-hud/update:timer:speed', JSON.stringify({
                        fps_speed: fps_speed
                    }));
                });
...
$('#minimap').change(function () {
    let on = this.checked
    $.post('https://warp-hud/ayar-minimap', JSON.stringify({
        minimap: on
    }));
});
...
ronin.CloseAyarMenu = function () {
    ...
    $.post('https://warp-hud/close-ayar-menu');
};
...
function ChangePhoneWallpaper() {
    ...
    $.post('https://warp-hud/change_wallpaper', JSON.stringify({ wallpaperURL }));
}
...
function MinimapBox() {
    ...
    if (checkBox.checked == true) {
        $.post('https://warp-hud/minimap_clip', JSON.stringify({ returnvalue }));
        console.log('CHECKING CHECKBOX')
    } else {
        $.post('https://warp-hud/minimap_clip2', JSON.stringify({ returnvalue }));
