...
RegisterServerEvent('warp-hud:buy_can')
AddEventHandler('warp-hud:buy_can', function()
	local src = source
...
RegisterServerEvent('warp-hud:UpdateStress_SV')
AddEventHandler('warp-hud:UpdateStress_SV',function(amount)
	local src = source
	local user = exports["warp-base"]:getModule("Player"):GetUser(src)
...
RegisterNetEvent("warp-hud:getping:sv")
AddEventHandler("warp-hud:getping:sv", function()
    local src = source 
    local ping = GetPlayerPing(src)
    TriggerClientEvent("warp-hud:getping:cl", src, ping)
end)
