...
RegisterServerEvent('warp-scoreboard:AddPlayer')
AddEventHandler("warp-scoreboard:AddPlayer", function()
    ...
    TriggerClientEvent("warp-scoreboard:AddPlayer", -1, data )
...
function Void.Scoreboard.AddAllPlayers(self)
    ...
    for i, _PlayerId in pairs(GetPlayers()) do
        ...
        TriggerClientEvent("warp-scoreboard:AddAllPlayers", source, data)
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("warp-scoreboard:RemovePlayer", -1, data )
    TriggerEvent('warp-scoreboard:updatePlayerCount')
    Wait(600000)
    TriggerClientEvent("warp-scoreboard:RemoveRecent", -1, plyid)
end)
...
RegisterServerEvent('warp-scoreboard:updatePlayerCount')
AddEventHandler("warp-scoreboard:updatePlayerCount", function()
    local playersonline = GetNumPlayerIndices()
    TriggerClientEvent("warp-scoreboard:playerscount", -1, playersonline)
end)