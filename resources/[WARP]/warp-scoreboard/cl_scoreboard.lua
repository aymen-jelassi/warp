...
RegisterNetEvent("warp-scoreboard:playerscount")
AddEventHandler("warp-scoreboard:playerscount", function(a)
    playerOnline = a
end)
...
RegisterNetEvent("warp-scoreboard:RemovePlayer")
AddEventHandler("warp-scoreboard:RemovePlayer", function(data)
    Void.Scoreboard:RemovePlayer(data)
end)

RegisterNetEvent("warp-scoreboard:AddPlayer")
AddEventHandler("warp-scoreboard:AddPlayer", function(data)
    Void.Scoreboard:AddPlayer(data)
end)

RegisterNetEvent("warp-scoreboard:RemoveRecent")
AddEventHandler("warp-scoreboard:RemoveRecent", function(src)
    Void.Scoreboard:RemoveRecent(src)
end)

RegisterNetEvent("warp-scoreboard:AddAllPlayers")
AddEventHandler("warp-scoreboard:AddAllPlayers", function(data)
