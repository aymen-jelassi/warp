RegisterServerEvent('warp-blackmarket:makeorder')
AddEventHandler('warp-blackmarket:makeorder', function(data)
    local src = source
    local user = exports["warp-base"]:getModule("Player"):GetUser(source,data)
...
Citizen.CreateThread(function()
    while true do
        ...
        if BlackMarket == 'warp-blackmarket' then 
            BlackMarket = true
