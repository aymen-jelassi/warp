local blips = {
    ...
    {id = "rockfordrecords", name = "Rockford Records", scale = 0.8, color = 3, sprite = 136, x = -1022.95, y= -262.34, z= 39.04},
    {id = "paintball2", name = "Paintball", scale = 0.8, color = 3, sprite = 470, x = 2341.91, y= 2558.8, z= 46.66},  
    {id = "recycle5g", name = "Recycle Center", scale = 0.8, color = 2, sprite = 643, x = 746.79, y= -1399.0, z= 26.54},  
    {id = "uwucafe", name = "UwU Cafe", scale = 0.8, color = 23, sprite = 304, x = -579.5027, y= -1061.327, z= 22.3519},
    {id = "bahama", name = "Bahama Mamas", scale = 0.5, color = 3, sprite = 536, x = -1389.431, y= -593.625, z= 30.319253},
    {id = "BurgerpiereShot", name = "Burgershot Piere", scale = 0.5, color = 1, sprite = 106, x=-1685.676, y=-1090.375, z= 13.156004}, 
}

AddEventHandler("warp-base:playerSessionStarted", function()
