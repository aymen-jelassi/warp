...
function Void.DataControls.setBindTable(controlTable,shouldSend)
	if controlTable == nil then
		...
		TriggerServerEvent('warp-base:sv:player_control_set',Void.Controls.Current)
...
RegisterNetEvent("warp-base:cl:player_control")
AddEventHandler("warp-base:cl:player_control", function(controlTable)
...
RegisterNetEvent('warp-base:setcontrols')
AddEventHandler('warp-base:setcontrols', function()
	TriggerServerEvent('warp-base:sv:player_controls')
end)
