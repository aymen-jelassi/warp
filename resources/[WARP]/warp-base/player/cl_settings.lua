...
function Void.SettingsData.setSettingsTable(settingsTable, shouldSend)
  if settingsTable == nil then
    ...
    TriggerServerEvent('warp-base:sv:player_settings_set',Void.Settings.Current)
...
RegisterNetEvent("warp-base:cl:player_settings")
AddEventHandler("warp-base:cl:player_settings", function(settingsTable)
  Void.SettingsData.setSettingsTable(settingsTable,false)
end)


RegisterNetEvent("warp-base:cl:player_reset")
AddEventHandler("warp-base:cl:player_reset", function(tableName)
