...
function Void.Core.ConsoleLog(self, msg, mod, ply)
	...
	if ply and tonumber(ply) then
		TriggerClientEvent("warp-base:consoleLog", ply, msg, mod)
	end
end

AddEventHandler("onResourceStart", function(resource)
	TriggerClientEvent("warp-base:waitForExports", -1)
...
RegisterNetEvent("warp-base:playerSessionStarted")
...
Citizen.CreateThread(function()
	while true do
		...
		print("^1[warp-base] Paychecks Sent^0")
	end
end)
