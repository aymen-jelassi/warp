...
RegisterNetEvent("warp-base:consoleLog")
AddEventHandler("warp-base:consoleLog", function(msg, mod)
...
-- RegisterNetEvent('warp-mdt:delreport')
-- AddEventHandler('warp-mdt:delreport', function()
--     local src = source
--     local user = exports["warp-base"]:getModule("Player"):GetUser(src)
...
-- RegisterNetEvent('warp-mdt:delwarrant')
-- AddEventHandler('warp-mdt:delwarrant', function()
--     local src = source
--     local user = exports["warp-base"]:getModule("Player"):GetUser(src)
--     local char = user:getCurrentCharacter()
--     local hexId = user:getVar("hexid")
