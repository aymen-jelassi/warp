...
function Void.Events.Trigger(self, event, args, callback)
    ...
    TriggerServerEvent("warp-events:listenEvent", id, event, args)
end

RegisterNetEvent("warp-events:listenEvent")
AddEventHandler("warp-events:listenEvent", function(id, data)
