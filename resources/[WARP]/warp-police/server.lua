...
AddEventHandler('police:targetCheckBank', function(target)
	local src = source
	local user = exports["warp-base"]:getModule("Player"):GetUser(target)
...
AddEventHandler("police:targetCheckInventory", function(target, status)
	local src = source
	local user2 = exports["warp-base"]:getModule("Player"):GetUser(target)
...
AddEventHandler('police:jailGranted', function(args)
	...
	local target = exports["warp-base"]:getModule("Player"):GetUser(player)
	local character = target:getCurrentCharacter()
	local playerName = character.first_name .. ' ' .. character.last_name

	local pdunit = exports["warp-base"]:getModule("Player"):GetUser(src)
	...
	exports["warp-base"]:getModule("JobManager"):SetJob(target, "unemployed", true)
end)
...
AddEventHandler('police:dnaAsk', function(t)
	local src = source
	local user2 = exports["warp-base"]:getModule("Player"):GetUser(t)
...
RegisterServerEvent('warp-base:Licenses')
AddEventHandler('warp-base:Licenses', function()
    local src = source
	local user = exports["warp-base"]:getModule("Player"):GetUser(src)
	local char = user:getCurrentCharacter()
...
RegisterServerEvent('warp-base:updatedphoneLicenses')
AddEventHandler('warp-base:updatedphoneLicenses', function()
	local src = source
	local user = exports["warp-base"]:getModule("Player"):GetUser(src)
	local char = user:getCurrentCharacter()
	local licenceTable = {}
...
RegisterServerEvent('warp-base:addLicenses')
AddEventHandler('warp-base:addLicenses', function()
	local src = source
	local user2 = exports["warp-base"]:getModule("Player"):GetUser(src)
	local char2 = user2:getCurrentCharacter()
...
RegisterServerEvent('warp-base:giveLicenses')
AddEventHandler('warp-base:giveLicenses', function(t)
	local src = source
	local user2 = exports["warp-base"]:getModule("Player"):GetUser(t)
	local char2 = user2:getCurrentCharacter()
...
RegisterServerEvent('warp-base:removeLicenses')
AddEventHandler('warp-base:removeLicenses', function(t)
	local src = source
	local user2 = exports["warp-base"]:getModule("Player"):GetUser(t)
	local char2 = user2:getCurrentCharacter()
...
RegisterServerEvent('warp-base:giveLicenseshunt')
AddEventHandler('warp-base:giveLicenseshunt', function(t)
	local src = source
	local user2 = exports["warp-base"]:getModule("Player"):GetUser(t)
	local char2 = user2:getCurrentCharacter()
...
RegisterServerEvent('warp-base:removeLicenseshunt')
AddEventHandler('warp-base:removeLicenseshunt', function(t)
	local src = source
	local user2 = exports["warp-base"]:getModule("Player"):GetUser(t)
	local char2 = user2:getCurrentCharacter()
...
RegisterServerEvent('warp-base:giveLicensesfish')
AddEventHandler('warp-base:giveLicensesfish', function(t)
	local src = source
	local user2 = exports["warp-base"]:getModule("Player"):GetUser(t)
	local char2 = user2:getCurrentCharacter()
...
RegisterServerEvent('warp-base:removeLicensesfish')
AddEventHandler('warp-base:removeLicensesfish', function(t)
	local src = source
	local user2 = exports["warp-base"]:getModule("Player"):GetUser(t)
	local char2 = user2:getCurrentCharacter()
...
AddEventHandler('police:getLicenses', function(t)
	local src = source
	local user = exports["warp-base"]:getModule("Player"):GetUser(t)
	local char = user:getCurrentCharacter()
...
RegisterCommand('bill', function(source, args)
    local src = source
	local user = exports["warp-base"]:getModule("Player"):GetUser(tonumber(args[1]))
	local character = user:getCurrentCharacter()
	local user2 = exports["warp-base"]:getModule("Player"):GetUser(src)
	local character2 = user2:getCurrentCharacter()
	...
	exports.oxmysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		for i, v in pairs(result) do
			if v.name == "heat" and v.rank >= 5 then
				TriggerClientEvent('warp-jobsystem:heatJobMenuHire', src)
			end
		end
	end)
end)
...
RegisterCommand("fireHeat", function(source)
	...
	exports.oxmysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		for i, v in pairs(result) do
			if v.name == "heat" and v.rank >= 5 then
				TriggerClientEvent('warp-jobsystem:heatJobMenuFire', src)
			end
		end
	end)
end)
	...
	exports.oxmysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		for i, v in pairs(result) do
			if v.name == "casino" and v.rank >= 4 then
				TriggerClientEvent('warp-jobsystem:casinoJobMenuHire', src)
			end
		end
	end)
end)
...
RegisterCommand("firecasino", function(source)
	...
	exports.oxmysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		for i, v in pairs(result) do
			if v.name == "casino" and v.rank >= 4 then
				TriggerClientEvent('warp-jobsystem:casinoJobMenuFire', src)
			end
		end
	end)
end)
	...
	exports.oxmysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		for i, v in pairs(result) do
			if v.name == "yakuza" and v.rank >= 5 then
				TriggerClientEvent('warp-jobsystem:yakuzaJobMenuHire', src)
			end
		end
	end)
end)
...
RegisterCommand("fireyakuza", function(source)
	...
	exports.oxmysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		for i, v in pairs(result) do
			if v.name == "yakuza" and v.rank >= 5 then
				TriggerClientEvent('warp-jobsystem:yakuzaJobMenuFire', src)
			end
		end
	end)
end)
	...
	exports.oxmysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		for i, v in pairs(result) do
			if v.name == "bondi_boys" and v.rank >= 4 then
				TriggerClientEvent('warp-jobsystem:bondiJobMenuHire', src)
			end
		end
	end)
end)
...
RegisterCommand("firebondi", function(source)
	...
	exports.oxmysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		for i, v in pairs(result) do
			if v.name == "bondi_boys" and v.rank >= 4 then
				TriggerClientEvent('warp-jobsystem:bondiJobMenuFire', src)
			end
		end
	end)
end)
...
RegisterServerEvent('warp-police:restore_car')
AddEventHandler("warp-police:restore_car", function(plate)
