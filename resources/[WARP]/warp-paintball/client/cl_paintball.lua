...
Citizen.CreateThread(function()
  exports["warp-polyzone"]:AddBoxZone("paintball_arena", vector3(2341.91, 2558.8, 46.66), 150, 120, {
...
AddEventHandler('warp:paintball:gun', function()
  if not exports["warp-inventory"]:hasEnoughOfItem("-2009644972",1,false) then
...
AddEventHandler('warp:paintball:ammo', function()
  if not exports["warp-inventory"]:hasEnoughOfItem("paintballs",5,false) then
...
function removeGuns()
  local qty = exports["warp-inventory"]:getQuantity("-2009644972")
...
RegisterNetEvent("warp-paintball:menu")
AddEventHandler("warp-paintball:menu", function()
