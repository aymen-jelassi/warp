...
function syncNative(name, netEntity, options, ...)
    TriggerServerEvent("warp-sync:executeSyncNative", name, netEntity, options, table.pack(...))
end
exports("syncNative", syncNative)

RegisterNetEvent("warp-sync:clientExecuteSyncNative")
AddEventHandler("warp-sync:clientExecuteSyncNative", function(native, netEntity, options, args)
