...
function SpawnVehicle(vehicle, pGarage, Fuel, customized, plate, IsViewing)
    ...
    elseif exports['warp-menu']:houseGarageCoords() ~= nil and exports['warp-menu']:NearHouseGarage() then
        HousingSpawn = exports['warp-menu']:houseGarageCoords()
	...
	Citizen.CreateThread(function()			
        ...
        if not IsViewing then    
            CurrentDisplayVehicle = nil
            RPC.execute("warp-garages:states", "Out", plate, exports['warp-menu']:currentGarage())
        end
    end)
end
